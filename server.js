...
const EMPTY_FINANCE = () => ({ services: [], recurring: [] });
const EMPTY_DB = () => ({ library: [], cards: [], events: [], beliefs: [], intro: null, birthdays: [], notified: [], appointments: [], works: [], uiState: EMPTY_UI_STATE(), finance: EMPTY_FINANCE(), ownerChatId: null });
...
async function load() {
  ...
  try {
    ...
    const { _id, ...data } = doc;
    return { library:[], cards:[], events:[], beliefs:[], intro:null, birthdays:[], notified:[], appointments:[], works:[], uiState: EMPTY_UI_STATE(), finance: EMPTY_FINANCE(), ownerChatId: null, ...data };
  } catch(e) {
...
{
  "rubric": "idea|dream|task|thought|notebook|birthday|event|shopping|media|work|quote",
  "split": false,
  "birthdayName": "",
  "birthdayDay": null,
  "birthdayMonth": null,
...
const R_EMOJI = { idea:'🔥', dream:'🌙', task:'🎯', thought:'💭', notebook:'📌', birthday:'🎂', event:'📅', shopping:'🛒', work:'💼', resentment:'😤', admiration:'✨', quote:'💬', media:'🎨', context:'🌀' };
const R_LABEL = { idea:'Идея', dream:'Сон', task:'Задача', thought:'Мысль', notebook:'Не забыть', birthday:'День рождения', event:'Мероприятие', shopping:'Покупка', work:'Работа', resentment:'Обида', admiration:'Восхищение', quote:'Цитата', media:'Искусство', context:'Контекст' };
